...
resource "aws_iam_role" "hush_security" {
...
resource "aws_iam_role_policy_attachment" "security_audit" {
  ...
  role       = aws_iam_role.hush_security.name
  policy_arn = "arn:aws:iam::aws:policy/SecurityAudit"
}

data "aws_iam_policy_document" "hush_security" {
  statement {
    sid    = "RoleAssumption"
    effect = "Allow"
    actions = [
    ...
    resources = [aws_iam_role.hush_security.arn]
  }
...
resource "aws_iam_role_policy" "hush_security" {
  name   = local.role_name
  role   = aws_iam_role.hush_security.id
  policy = data.aws_iam_policy_document.hush_security.json
}
